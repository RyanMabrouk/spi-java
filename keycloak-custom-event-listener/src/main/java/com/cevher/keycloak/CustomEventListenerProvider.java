...
public class CustomEventListenerProvider
    ...
    public void onEvent(Event event) {
        ...
        System.out.println("New %s Event "+ event.getType());
    ...
    public void onEvent(AdminEvent adminEvent, boolean b) {
        System.out.println("onEvent(AdminEvent)");
        ...
        if (ResourceType.USER.equals(adminEvent.getResourceType())
            ...
            try {
              ...
              this.session.getTransactionManager().commit();
                ...
                log.errorf("Failed to call API: %s", e);
                adminEvent.setError("User data has not been sent to the API");
                this.session.getTransactionManager().rollback();
            }
        }
    }
